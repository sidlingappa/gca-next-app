...
export const UserProfileDetails = ({user,role}:UserInfoProps) => {
 ...
 const { control, handleSubmit,reset,setValue } = useForm({mode: 'onChange',reValidateMode: 'onChange'});
            ...
            <Grid item md={6} xs={12} >
              ...
              defaultValue=""
               ...
               render={({ field:{ onChange, value }, fieldState: { error } }) => (
                <TextField fullWidth={true} required ={true}  label="First name"
               onChange={onChange}
                 value={value}
                 error={!!error}
                             helperText={error ? error.message : "Please specify the first name"}
                 variant="outlined"/> )} />
            ...
            <Grid item md={6} xs={12} >
             ...
             defaultValue=""
              ...
              render={({ field:{ onChange, value } }) => (
                <TextField fullWidth={true} required ={true} helperText="Please specify the last name" label="Last name"
                 onChange={onChange}
                 value={value}
                 variant="outlined"/> )} />
            </Grid>
